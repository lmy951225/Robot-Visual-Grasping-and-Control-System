...
namespace amc::dynamic
{
	...
	{
		std::unique_ptr<amc::dynamic::Model> model = std::make_unique<amc::dynamic::Model>("model");
		...
		// 添加变量 //
		model->calculator().addVariable("PI", amc::core::Matrix(PI));
		...
		p1a.geometryPool().add<amc::dynamic::ParasolidGeometry>("test", "C:\\amc\\amc-1.5.0\\resource\\test_dynamic\\stewart\\pa.xmt_txt");
		p1b.geometryPool().add<amc::dynamic::ParasolidGeometry>("test", "C:\\amc\\amc-1.5.0\\resource\\test_dynamic\\stewart\\pb.xmt_txt");
		p2a.geometryPool().add<amc::dynamic::ParasolidGeometry>("test", "C:\\amc\\amc-1.5.0\\resource\\test_dynamic\\stewart\\pa.xmt_txt");
		p2b.geometryPool().add<amc::dynamic::ParasolidGeometry>("test", "C:\\amc\\amc-1.5.0\\resource\\test_dynamic\\stewart\\pb.xmt_txt");
		p3a.geometryPool().add<amc::dynamic::ParasolidGeometry>("test", "C:\\amc\\amc-1.5.0\\resource\\test_dynamic\\stewart\\pa.xmt_txt");
		p3b.geometryPool().add<amc::dynamic::ParasolidGeometry>("test", "C:\\amc\\amc-1.5.0\\resource\\test_dynamic\\stewart\\pb.xmt_txt");
		p4a.geometryPool().add<amc::dynamic::ParasolidGeometry>("test", "C:\\amc\\amc-1.5.0\\resource\\test_dynamic\\stewart\\pa.xmt_txt");
		p4b.geometryPool().add<amc::dynamic::ParasolidGeometry>("test", "C:\\amc\\amc-1.5.0\\resource\\test_dynamic\\stewart\\pb.xmt_txt");
		p5a.geometryPool().add<amc::dynamic::ParasolidGeometry>("test", "C:\\amc\\amc-1.5.0\\resource\\test_dynamic\\stewart\\pa.xmt_txt");
		p5b.geometryPool().add<amc::dynamic::ParasolidGeometry>("test", "C:\\amc\\amc-1.5.0\\resource\\test_dynamic\\stewart\\pb.xmt_txt");
		p6a.geometryPool().add<amc::dynamic::ParasolidGeometry>("test", "C:\\amc\\amc-1.5.0\\resource\\test_dynamic\\stewart\\pa.xmt_txt");
		p6b.geometryPool().add<amc::dynamic::ParasolidGeometry>("test", "C:\\amc\\amc-1.5.0\\resource\\test_dynamic\\stewart\\pb.xmt_txt");
		up.geometryPool().add<amc::dynamic::ParasolidGeometry>("test", "C:\\amc\\amc-1.5.0\\resource\\test_dynamic\\stewart\\up.xmt_txt");
		...
		auto &ee = model->generalMotionPool().add<amc::dynamic::GeneralMotion>("ee", &makI, &makJ, false);

		// add solver
		auto &inverse_kinematic = model->solverPool().add<amc::dynamic::StewartInverseKinematicSolver>();
		auto &forward_kinematic = model->solverPool().add<amc::dynamic::ForwardKinematicSolver>();
		auto &inverse_dynamic = model->solverPool().add<amc::dynamic::InverseDynamicSolver>();
		auto &forward_dynamic = model->solverPool().add<amc::dynamic::ForwardDynamicSolver>();
	...
	auto StewartInverseKinematicSolver::kinPos()->bool
	{
		...
		for (auto i = 0; i < 6; ++i)
		{
			...
			amc::dynamic::s_sov_axes2pm(&u_pmj[0][3], 4, p_dir_global, 1, second_axis_global, 1, pm1,"xy");
			amc::dynamic::s_sov_axes2pm(&imp_->u_[i]->makI().prtPm()[0][3], 4, p_dir_in_pa, 1, second_axis_in_pa, 1, pm2, "xy");
			...
			//amc::dynamic::s_sov_axes2pm(&s_pmj[0][3], 4, p_dir_global, 1, second_axis_global, 1, pm1, "xy");
			//amc::dynamic::s_sov_axes2pm(&imp_->s_[i]->makI().prtPm()[0][3], 4, p_dir_in_pb, 1, second_axis_in_pb, 1, pm2, "xy");
	...
	AMC_DEFINE_BIG_FOUR_CPP(StewartInverseKinematicSolver);
}
