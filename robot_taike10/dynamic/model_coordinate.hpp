#ifndef AMC_DYNAMIC_MODEL_COORDINATE_H_
#define AMC_DYNAMIC_MODEL_COORDINATE_H_

#include "model_basic.hpp"
...
namespace amc::dynamic
{
	...
	public:
		...
		AMC_REGISTER_TYPE(Coordinate);
		AMC_DEFINE_BIG_FOUR(Coordinate);
	};
	...
	public:
		...
		AMC_REGISTER_TYPE(Marker);
		AMC_DECLARE_BIG_FOUR(Marker);
	...
	public:
		...
		auto markerPool() noexcept->amc::core::ObjectPool<Marker, Element>&;
		auto markerPool()const noexcept->const amc::core::ObjectPool<Marker, Element>&;
		auto geometryPool() noexcept->amc::core::ObjectPool<Geometry, Element>&;
		auto geometryPool()const noexcept->const amc::core::ObjectPool<Geometry, Element>&;
		...
		AMC_REGISTER_TYPE(Part);
		AMC_DECLARE_BIG_FOUR(Part);
	...
	public:
		...
		AMC_REGISTER_TYPE(Geometry);
		AMC_DEFINE_BIG_FOUR(Geometry);
	};
	...
	public:
		...
		AMC_REGISTER_TYPE(ParasolidGeometry);
		AMC_DECLARE_BIG_FOUR(ParasolidGeometry);
	...
	public:
		...
		AMC_REGISTER_TYPE(FileGeometry);
		AMC_DECLARE_BIG_FOUR(FileGeometry);
	...
	public:
		...
		AMC_REGISTER_TYPE(ShellGeometry);
		AMC_DECLARE_BIG_FOUR(ShellGeometry);
