...
namespace amc::dynamic
{
	...
	auto Marker::saveXml(amc::core::XmlElement &xml_ele) const->void
	{
	...
	auto Marker::loadXml(const amc::core::XmlElement &xml_ele)->void
	{
		...
		{
			try { s_pm_dot_pm(*static_cast<amc::core::ObjectPool<Marker, Element>*>(this->father())->findByName(xml_ele.Attribute("relative_to"))->prtPm(), pm, *imp_->prt_pm_); }
	...
	{
		double global_pm[16];
		s_pm_dot_pm(*relative_to.pm(), pm, global_pm);
		setPm(global_pm);
	}
	...
	struct Part::Imp
	{
		amc::core::ObjectPool<Marker, Element> *marker_pool_;
		amc::core::ObjectPool<Geometry, Element> *geometry_pool_;
	...
	auto Part::saveXml(amc::core::XmlElement &xml_ele) const->void
	{
		DynEle::saveXml(xml_ele);
	...
	auto Part::loadXml(const amc::core::XmlElement &xml_ele)->void
	{
		...
		imp_->marker_pool_ = findOrInsertType<amc::core::ObjectPool<Marker, Element> >();
		imp_->geometry_pool_ = findOrInsertType<amc::core::ObjectPool<Geometry, Element> >();

	}
	auto Part::markerPool() noexcept->amc::core::ObjectPool<Marker, Element>& { return *imp_->marker_pool_; }
	auto Part::markerPool()const noexcept->const amc::core::ObjectPool<Marker, Element>& { return *imp_->marker_pool_; }
	auto Part::geometryPool() noexcept->amc::core::ObjectPool<Geometry, Element>& { return *imp_->geometry_pool_; }
	auto Part::geometryPool()const noexcept->const amc::core::ObjectPool<Geometry, Element>& { return *imp_->geometry_pool_; }
	...
	{
		this->registerType<amc::core::ObjectPool<Marker, Element> >();
		this->registerType<amc::core::ObjectPool<Geometry, Element> >();
		
		imp_->marker_pool_ = &add<amc::core::ObjectPool<Marker, Element> >("marker_pool");
		imp_->geometry_pool_ = &add<amc::core::ObjectPool<Geometry, Element> >("geometry_pool");
	...
	{
		imp_->marker_pool_ = findType<amc::core::ObjectPool<Marker, Element> >("marker_pool");
		imp_->geometry_pool_ = findType<amc::core::ObjectPool<Geometry, Element> >("geometry_pool");
	};
	...
	Part& Part::operator=(Part &&other)
	{
		...
		imp_ = other.imp_;
		imp_->marker_pool_ = &static_cast<amc::core::ObjectPool<Marker, Element> &>(*findByName("marker_pool"));
		imp_->geometry_pool_ = &static_cast<amc::core::ObjectPool<Geometry, Element> &>(*findByName("geometry_pool"));
		return *this;
	}
	...
	auto ParasolidGeometry::saveXml(amc::core::XmlElement &xml_ele) const->void
	{
	...
	auto ParasolidGeometry::loadXml(const amc::core::XmlElement &xml_ele)->void
	{
		double pm[16];
	...
	auto FileGeometry::saveXml(amc::core::XmlElement &xml_ele) const->void
	{
		Element::saveXml(xml_ele);
		double pe[6];
		s_pm2pe(*imp_->prt_pm_, pe);
	...
	auto FileGeometry::loadXml(const amc::core::XmlElement &xml_ele)->void
	{
		double pm[16];
		s_pe2pm(attributeMatrix(xml_ele, "pe", 1, 6, core::Matrix(1, 6, 0.0)).data(), pm);
	...
	auto ShellGeometry::saveXml(amc::core::XmlElement &xml_ele) const->void
	{
		Element::saveXml(xml_ele);
		xml_ele.SetAttribute("relative_to", imp_->relative_to_->name().c_str());
		xml_ele.SetAttribute("graphic_file_path", imp_->graphic_file_path.c_str());
	}
	auto ShellGeometry::loadXml(const amc::core::XmlElement &xml_ele)->void
	{
		double pm[16];
		s_pe2pm(attributeMatrix(xml_ele, "pe", 1, 6, core::Matrix(1, 6, 0.0)).data(), pm);
		...
		if (xml_ele.Attribute("relative_to"))
		{
			try { imp_->relative_to_ = &*static_cast<amc::core::ObjectPool<Marker, Element>*>(this->father())->findByName(xml_ele.Attribute("relative_to")); }
			catch (std::exception &) { throw std::runtime_error(std::string("can't find relative marker for element \"") + this->name() + "\""); }
		}
		else
		{
