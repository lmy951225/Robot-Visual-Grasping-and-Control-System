#ifndef AMC_DYNAMIC_MODEL_SOLVER_H_
#define AMC_DYNAMIC_MODEL_SOLVER_H_
...
namespace amc::dynamic
{
	...
	public:
		...
		AMC_REGISTER_TYPE(Solver);
		AMC_DECLARE_BIG_FOUR(Solver);
	...
	public:
		...
		AMC_REGISTER_TYPE(UniversalSolver);
		AMC_DECLARE_BIG_FOUR(UniversalSolver);
	...
	public:
		...
		AMC_REGISTER_TYPE(ForwardKinematicSolver);
		AMC_DECLARE_BIG_FOUR(ForwardKinematicSolver);
	...
	public:
		...
		AMC_REGISTER_TYPE(InverseKinematicSolver);
		AMC_DECLARE_BIG_FOUR(InverseKinematicSolver);
	...
	public:
		...
		AMC_REGISTER_TYPE(ForwardDynamicSolver);
		AMC_DECLARE_BIG_FOUR(ForwardDynamicSolver);
	};
	...
	public:
		...
		AMC_REGISTER_TYPE(InverseDynamicSolver);
		AMC_DECLARE_BIG_FOUR(InverseDynamicSolver);
	};
	///
	/// @}
}
