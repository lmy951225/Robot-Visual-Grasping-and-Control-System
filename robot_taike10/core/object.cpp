...
namespace amc::core
{
	...
	auto Object::attributeBool(const amc::core::XmlElement &xml_ele, const std::string &attribute_name)->bool
	{
	...
	auto Object::attributeBool(const amc::core::XmlElement &xml_ele, const std::string &attribute_name, bool default_value)->bool
	{
		return xml_ele.Attribute(attribute_name.c_str()) ? attributeBool(xml_ele, attribute_name) : default_value;
	}
	auto Object::attributeInt64(const amc::core::XmlElement &xml_ele, const std::string &attribute_name)->std::int64_t
	{
	...
	auto Object::attributeInt64(const amc::core::XmlElement &xml_ele, const std::string &attribute_name, std::int64_t default_value)->std::int64_t
	{
		return xml_ele.Attribute(attribute_name.c_str()) ? attributeInt64(xml_ele, attribute_name) : default_value;
	}
	auto Object::attributeInt32(const amc::core::XmlElement &xml_ele, const std::string &attribute_name)->std::int32_t
	{
	...
	auto Object::attributeInt32(const amc::core::XmlElement &xml_ele, const std::string &attribute_name, std::int32_t default_value)->std::int32_t
	{
		return xml_ele.Attribute(attribute_name.c_str()) ? attributeInt32(xml_ele, attribute_name) : default_value;
	}
	auto Object::attributeInt16(const amc::core::XmlElement &xml_ele, const std::string &attribute_name)->std::int16_t
	{
	...
	auto Object::attributeInt16(const amc::core::XmlElement &xml_ele, const std::string &attribute_name, std::int16_t default_value)->std::int16_t
	{
		return xml_ele.Attribute(attribute_name.c_str()) ? attributeInt16(xml_ele, attribute_name) : default_value;
	}
	auto Object::attributeInt8(const amc::core::XmlElement &xml_ele, const std::string &attribute_name)->std::int8_t
	{
		std::string error = "failed to get int16 attribute \"" + attribute_name + "\" in element \"" + xml_ele.Name() + "\", because ";
	...
	auto Object::attributeInt8(const amc::core::XmlElement &xml_ele, const std::string &attribute_name, std::int8_t default_value)->std::int8_t
	{
		return xml_ele.Attribute(attribute_name.c_str()) ? attributeInt8(xml_ele, attribute_name) : default_value;
	}
	auto Object::attributeUint64(const amc::core::XmlElement &xml_ele, const std::string &attribute_name)->std::uint64_t
	{
	...
	auto Object::attributeUint64(const amc::core::XmlElement &xml_ele, const std::string &attribute_name, std::uint64_t default_value)->std::uint64_t
	{
		return xml_ele.Attribute(attribute_name.c_str()) ? attributeUint64(xml_ele, attribute_name) : default_value;
	}
	auto Object::attributeUint32(const amc::core::XmlElement &xml_ele, const std::string &attribute_name)->std::uint32_t
	{
	...
	auto Object::attributeUint32(const amc::core::XmlElement &xml_ele, const std::string &attribute_name, std::uint32_t default_value)->std::uint32_t
	{
		return xml_ele.Attribute(attribute_name.c_str()) ? attributeUint32(xml_ele, attribute_name) : default_value;
	}
	auto Object::attributeUint16(const amc::core::XmlElement &xml_ele, const std::string &attribute_name)->std::uint16_t
	{
	...
	auto Object::attributeUint16(const amc::core::XmlElement &xml_ele, const std::string &attribute_name, std::uint16_t default_value)->std::uint16_t
	{
		return xml_ele.Attribute(attribute_name.c_str()) ? attributeUint16(xml_ele, attribute_name) : default_value;
	}
	auto Object::attributeUint8(const amc::core::XmlElement &xml_ele, const std::string &attribute_name)->std::uint8_t
	{
	...
	auto Object::attributeUint8(const amc::core::XmlElement &xml_ele, const std::string &attribute_name, std::uint8_t default_value)->std::uint8_t
	{
		return xml_ele.Attribute(attribute_name.c_str()) ? attributeUint8(xml_ele, attribute_name) : default_value;
	}
	auto Object::attributeFloat(const amc::core::XmlElement &xml_ele, const std::string &attribute_name)->float
	{
	...
	auto Object::attributeFloat(const amc::core::XmlElement &xml_ele, const std::string &attribute_name, float default_value)->float
	{
		return xml_ele.Attribute(attribute_name.c_str()) ? attributeFloat(xml_ele, attribute_name) : default_value;
	}
	auto Object::attributeDouble(const amc::core::XmlElement &xml_ele, const std::string &attribute_name)->double
	{
		std::string error = "failed to get double attribute \"" + attribute_name + "\" in element \"" + xml_ele.Name() + "\", because ";
	...
	auto Object::attributeDouble(const amc::core::XmlElement &xml_ele, const std::string &attribute_name, double default_value)->double
	{
		return xml_ele.Attribute(attribute_name.c_str()) ? attributeDouble(xml_ele, attribute_name) : default_value;
	}
	auto Object::attributeString(const amc::core::XmlElement &xml_ele, const std::string &attribute_name)->std::string
	{
	...
	auto Object::attributeString(const amc::core::XmlElement &xml_ele, const std::string &attribute_name, const std::string &default_value)->std::string
	{
		return xml_ele.Attribute(attribute_name.c_str()) ? attributeString(xml_ele, attribute_name) : default_value;
	}
	auto Object::attributeChar(const amc::core::XmlElement &xml_ele, const std::string &attribute_name)->char
	{
	...
	auto Object::attributeChar(const amc::core::XmlElement &xml_ele, const std::string &attribute_name, char default_value)->char
	{
	...
	auto Object::saveXml(amc::core::XmlElement &xml_ele) const->void
	{
	...
	auto Object::loadXml(const amc::core::XmlElement &xml_ele)->void
	{
